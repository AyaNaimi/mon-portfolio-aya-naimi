...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "MongoDB", level: 62, color: "bg-green-700" },
      { name: "supabase", level: 85, color: "bg-red-500" },
                    ...
                    <div className="w-full h-2 bg-gray-200 rounded-full relative overflow-hidden progress-bar-patterned">
                      <div 
                        className={`h-full rounded-full transition-all duration-1000 ${
                          ...
                          categoryIndex === 2 ? 'progress-pattern-3 progress-database' :
                          'progress-pattern-4 progress-devops'
                        }`}
                        style={{
